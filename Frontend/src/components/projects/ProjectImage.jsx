...
export default function ProjectImage({ project, mobileReduced }) {
  ...
  return (
    <div ref={imageWrapRef} className="relative h-[210px] overflow-hidden sm:h-[250px] md:h-[260px] lg:h-[220px]">
      {/* Static aurora gradient backdrop (no animation). */}
      <div
        aria-hidden="true"
      ...
      {/* Static shine element (no animated transform). */}
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 -left-1/2 w-1/2 bg-[linear-gradient(110deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.5)_45%,rgba(255,255,255,0)_100%)]"
      />
    </div>
  );
}
